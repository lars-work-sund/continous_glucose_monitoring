...
glucose_statistics_sample <- function(by, sample_data, min_frac_summaries){
  ...
  out <- sample_data[, .(
    ...
    Median = as.numeric(median(filter_max_missing(Glucose, tmp_included, min_frac_summaries), na.rm = TRUE)),
    ...
    `25% quantile` = as.numeric((q25 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.25, na.rm = TRUE))),
    `75% quantile` = as.numeric((q75 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.75, na.rm = TRUE))),
    IQR = as.numeric(q75 - q25),
    `10% fractile` = as.numeric((q10 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.10, na.rm = TRUE))),
    `90% fractile` = as.numeric((q90 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.90, na.rm = TRUE))),
    `10% - 90% Range` = as.numeric(q90 - q10),
    `5% fractile` = as.numeric((q10 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.05, na.rm = TRUE))),
    `95% fractile` = as.numeric((q90 <- quantile(filter_max_missing(Glucose, tmp_included, min_frac_summaries), 0.95, na.rm = TRUE))),
...
isoglycemic_statistics_sample <- function(by, sample_data, min_frac_summaries){
  ...
  out <- sample_data[, .(
    ...
    CV = as.numeric(mean/sd),
    SEM = as.numeric(sd/sqrt(.N)),
    Median = as.numeric(median(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), na.rm = TRUE)),
    ...
    Range = as.numeric(high - low),
    `25% quantile` = as.numeric((q25 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.25, na.rm = TRUE))),
    `75% quantile` = as.numeric((q75 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.75, na.rm = TRUE))),
    IQR = as.numeric(q75 - q25),
    `10% fractile` = as.numeric((q10 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.10, na.rm = TRUE))),
    `90% fractile` = as.numeric((q90 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.90, na.rm = TRUE))),
    `10% - 90% Range` = as.numeric(q90 - q10),
    `5% fractile` = as.numeric((q10 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.05, na.rm = TRUE))),
    `95% fractile` = as.numeric((q90 <- quantile(filter_max_missing(iso_glucose, tmp_included, min_frac_summaries), 0.95, na.rm = TRUE))),
    Mean_Baseline = as.numeric(mean(filter_max_missing(baseline, tmp_included, min_frac_summaries), na.rm = TRUE)),
    SD_Baseline = as.numeric((sd_baseline <- sd(filter_max_missing(baseline, tmp_included, min_frac_summaries), na.rm = TRUE))),
    SEM_Baseline = as.numeric(sd_baseline/sqrt(.N))
  ),
